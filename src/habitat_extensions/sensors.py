...
from src.habitat_extensions.shortest_path_follower import (
    ShortestPathFollowerCompat,
)
from src.habitat_extensions.task import VLNExtendedEpisode
    ...
    def get_observation(
        ...
        **kwargs,
        ...
        return {
            ...
            "instruction_id": episode.instruction.instruction_id,
            "text_English": episode.instruction.instruction_text_English,
            "DAG": episode.instruction.instruction_DAG,
            "LLM_model": episode.instruction.LLM_model,
        }
